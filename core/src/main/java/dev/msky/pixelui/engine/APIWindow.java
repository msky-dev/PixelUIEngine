...
import dev.msky.pixelui.engine.actions.WindowAction;
...
public final class APIWindow {
    ...
    private final WindowAction DEFAULT_WINDOW_ACTION = new WindowAction() {
    };
    ...
    public Window createFromGenerator(WindowGenerator.P0 windowGenerator) {
        if (windowGenerator == null) return null;
        return windowGenerator.createWindow(api);
    }

    public <P1> Window createFromGenerator(WindowGenerator.P1<P1> windowGenerator, P1 p1) {
        if (windowGenerator == null) return null;
        return windowGenerator.createWindow(api, p1);
    }

    public <P1, P2> Window createFromGenerator(WindowGenerator.P2<P1, P2> windowGenerator, P1 p1, P2 p2) {
        if (windowGenerator == null) return null;
        return windowGenerator.createWindow(api, p1, p2);
    }

    public <P1, P2, P3> Window createFromGenerator(WindowGenerator.P3<P1, P2, P3> windowGenerator, P1 p1, P2 p2, P3 p3) {
        if (windowGenerator == null) return null;
        return windowGenerator.createWindow(api, p1, p2, p3);
    }

    public <P1, P2, P3, P4> Window createFromGenerator(WindowGenerator.P4<P1, P2, P3, P4> windowGenerator, P1 p1, P2 p2, P3 p3, P4 p4) {
        if (windowGenerator == null) return null;
        return windowGenerator.createWindow(api, p1, p2, p3, p4);
    }

    public <P1, P2, P3, P4, P5> Window createFromGenerator(WindowGenerator.P5<P1, P2, P3, P4, P5> windowGenerator, P1 p1, P2 p2, P3 p3, P4 p4, P5 p5) {
        if (windowGenerator == null) return null;
