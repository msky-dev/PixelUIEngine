...
public class WgSpriteRenderer extends CommonRenderer implements Disposable {
    ...
    protected WgShaderProgram provideDefaultShader() {
        return ShaderParser.parse(Tools.File.findResource("shaders/pixelui/default.sprite.glsl"));
    }
    ...
    public WgSpriteRenderer(final MediaManager mediaManager) {
        this(mediaManager, null, MAX_VERTEXES_DEFAULT);
    }

    public WgSpriteRenderer(final MediaManager mediaManager, final ShaderProgram defaultShader) {
        this(mediaManager, defaultShader, MAX_VERTEXES_DEFAULT);
    }

    public WgSpriteRenderer(final MediaManager mediaManager, final ShaderProgram defaultShader, final int maxVertexes) {
