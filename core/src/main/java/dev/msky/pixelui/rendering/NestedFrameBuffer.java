...
public class NestedFrameBuffer extends FrameBuffer {
    ...
    private int getBoundFboHandle() {
        ...
        Gdx.gl20.glGetIntegerv(GL20.GL_FRAMEBUFFER_BINDING, this.intBuffer);
  ...
  /*
        Gdx.gl20.glBindFramebuffer(GL20.GL_READ_FRAMEBUFFER, source.getFramebufferHandle());
        Gdx.gl20.glBindFramebuffer(GL20.GL_DRAW_FRAMEBUFFER, this.getFramebufferHandle());


        Gdx.gl20.glBlitFramebuffer(
        ...
        Gdx.gl20.glBindFramebuffer(GL20.GL_FRAMEBUFFER, previousFBO);
    }


    public NestedFrameBuffer createTrimmedCopy(SpriteRenderer batch,
                                               int srcX, int srcY,
                                               int trimW, int trimH) {
    ...
    public NestedFrameBuffer createTrimmedCopyAlphaThreshold(SpriteRenderer batch, float alphaThreshold) {
        ...
        return this.createTrimmedCopy(batch, minX, minY, trimW, trimH);
    }
