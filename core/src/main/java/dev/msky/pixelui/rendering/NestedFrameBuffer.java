...
public class NestedFrameBuffer extends FrameBuffer {
    ...
    private int getBoundFboHandle() {
        ...
        Gdx.gl32.glGetIntegerv(GL32.GL_FRAMEBUFFER_BINDING, this.intBuffer);
    ...
    private int[] getViewport() {
        ...
        Gdx.gl32.glGetIntegerv(GL32.GL_VIEWPORT, intBuf);
    ...
    @Override
    public void bind() {
        Gdx.gl32.glBindFramebuffer(GL32.GL_FRAMEBUFFER, framebufferHandle);
    }
    ...
    public void end(int x, int y, int width, int height) {
        ...
        isBound = false;
        Gdx.gl32.glBindFramebuffer(GL32.GL_FRAMEBUFFER, previousFBOHandle);
    }
