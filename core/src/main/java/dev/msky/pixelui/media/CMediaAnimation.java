...
public final class CMediaAnimation extends CMediaSprite implements Copyable<CMediaAnimation> {
    ...
    public CMediaAnimation(String file, int frameWidth, int frameHeight, float animationSpeed, int frameOffset, int frameLength, ExtendedAnimation.PlayMode playMode) {
        super(file);
