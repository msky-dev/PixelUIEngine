...
import dev.msky.pixelui.utils.settings.persistor.PropertiesFilePersistor;
import dev.msky.pixelui.utils.settings.validator.StringValueValidator;
...
public class SettingsManager {
    ...
    public SettingsManager(String path, SettingsPersistor settingsPersistor) {
    ...
    public record SettingsEntry(String name, String defaultValue, ValueValidator valueValidator) {
        @Override
