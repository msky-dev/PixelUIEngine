...
import dev.msky.pixelui.utils.particles.particles.*;
import dev.msky.pixelui.media.*;
...
public final class SpriteParticleSystem<T> extends ParticleSystem<T> {
    ...
    public SpriteParticleSystem(Class<T> dataClass,ParallelExecutor parallelExecutor, ParticleUpdater<T> particleUpdater) {
        this(dataClass,parallelExecutor, particleUpdater, Integer.MAX_VALUE,DEFAULT_RENDER_HOOK);
    }

    public SpriteParticleSystem(Class<T> dataClass,ParallelExecutor parallelExecutor, ParticleUpdater<T> particleUpdater, int maxParticles) {
        this(dataClass,parallelExecutor, particleUpdater, maxParticles, DEFAULT_RENDER_HOOK);
    }

    public SpriteParticleSystem(Class<T> dataClass, ParallelExecutor parallelExecutor, ParticleUpdater<T> particleUpdater, int maxParticles, RenderHook<T> renderHook) {
