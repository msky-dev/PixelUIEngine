########################################
# Windows Multiplatform package script
# Run with git bash
########################################
# Needed files:
# - 7z binary (packaging)
# - rcedit-x64.exe (windows .exe icons)
# - win/linux/mac JRE
# - windows .ico icon
# - mac: .icns icon
# - roast win/linux/macos-universal binaries (https://github.com/fourlastor-alexandria/roast/tree/main)
...
export MAIN_CLASS="dev.msky.example.ExampleLauncherMain"
