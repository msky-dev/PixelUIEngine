...
import dev.msky.pixelui.engine.*;
import dev.msky.pixelui.engine.Button;
import dev.msky.pixelui.engine.Checkbox;
import dev.msky.pixelui.engine.Component;
import dev.msky.pixelui.engine.Image;
import dev.msky.pixelui.engine.List;
import dev.msky.pixelui.engine.Scrollbar;
import dev.msky.pixelui.engine.TextField;
import dev.msky.pixelui.engine.Window;
...
import dev.msky.pixelui.media.CMediaArray;
import dev.msky.pixelui.media.CMediaImage;
...
public class ExampleWindowGeneratorP implements WindowGenerator.P1<MediaManager> {
    ...
    private Array<Component> createTab4(API api, Window window) {
        ...
        Text text4 = api.component.text.create(1, 2, 0, "!\"#$%&'()*+,-./:;<=>?@[\\]^_`{|}~€¥£©§");
        Text text5 = api.component.text.create(1, 1, 0, "T");
    ...
    private Array<Component> createTab2(API api, Window window) {
        ...
        api.component.addUpdateAction(frameBufferViewport, new UpdateAction() {
            ...
            public void onUpdate() {
                ...
                Gdx.gl20.glClearColor(Math.abs(MathUtils.sin(deg1)), 1f - Math.abs(MathUtils.sin(deg2)), 0f, 1f);
